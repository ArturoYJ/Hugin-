...
object Roles : IntIdTable("rol", "id_rol") {
    ...
    val createdAt = timestamp("fecha_creacion").defaultExpression(org.jetbrains.exposed.sql.CurrentTimestamp)
}
...
object RolePermissions : org.jetbrains.exposed.sql.Table("rol_permiso") {
    ...
    val assignedAt = timestamp("fecha_asignacion").defaultExpression(org.jetbrains.exposed.sql.CurrentTimestamp)
